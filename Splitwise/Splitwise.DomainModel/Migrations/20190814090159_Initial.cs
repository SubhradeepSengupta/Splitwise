    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserNotificationMappers", x => x.ID);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserNotificationMappers_AspNetUsers_UserID",
                        column: x => x.UserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "GroupExpenseMappers",
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GroupID = table.Column<int>(nullable: false),
                    SplitType = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupExpenseMappers", x => x.ID);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupExpenseMappers_AspNetUsers_Payee",
                        column: x => x.Payee,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserExpenseMappers", x => x.ID);
                    table.ForeignKey(
                        name: "FK_UserExpenseMappers_Currencies_CurrencyID",
                        column: x => x.CurrencyID,
                        principalTable: "Currencies",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserExpenseMappers_GroupExpenseMappers_ExpenseID",
                        column: x => x.ExpenseID,
                        principalTable: "GroupExpenseMappers",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupExpenseMappers_CurrencyID",
                table: "GroupExpenseMappers",
                column: "CurrencyID");

            migrationBuilder.CreateIndex(
                name: "IX_GroupExpenseMappers_GroupID",
                table: "GroupExpenseMappers",
                column: "GroupID");

            migrationBuilder.CreateIndex(
                name: "IX_GroupExpenseMappers_Payee",
                table: "GroupExpenseMappers",
                column: "Payee");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserExpenseMappers_CurrencyID",
                table: "UserExpenseMappers",
                column: "CurrencyID");

            migrationBuilder.CreateIndex(
                name: "IX_UserExpenseMappers_ExpenseID",
                table: "UserExpenseMappers",
                column: "ExpenseID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationMappers_NotificationID",
                table: "UserNotificationMappers",
                column: "NotificationID");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotificationMappers_UserID",
                table: "UserNotificationMappers",
                column: "UserID");
        }
